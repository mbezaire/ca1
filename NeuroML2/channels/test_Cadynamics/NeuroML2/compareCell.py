...
# -*- coding: utf-8 -*-
""" 
Reloads NEURON's saved results, runs jNeuroML and plots membrane potential and [Ca++]_i together (to compare Ca++ dynamics)
...
comp['[Ca++]'] = ('pop/0/cell1/caConc', 1)
#comp['iCa_CavL'] = ('pop/0/cell1/biophysicalProperties/membraneProperties/CavL_all/iDensity',2)
#comp['iCa_CavN'] = ('pop/0/cell1/biophysicalProperties/membraneProperties/CavN_all/iDensity',3)
